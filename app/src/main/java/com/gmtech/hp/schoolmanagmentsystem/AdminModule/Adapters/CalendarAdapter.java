...
public class CalendarAdapter extends BaseAdapter {
    ...
    public ArrayList<HolidayModel>  date_collection_arr;

    public CalendarAdapter(Context context, GregorianCalendar monthCalendar,
                           ArrayList<HolidayModel> date_collection_arr) {
   ...
   public void setEventView(View v,int pos,TextView txt){
    if(HolidayModel.date_collection_arr!=null) {
        int len = HolidayModel.date_collection_arr.size();
        for (int i = 0; i < len; i++) {
            HolidayModel cal_obj = HolidayModel.date_collection_arr.get(i);
            ...
            if (len1 > pos) {
                ...
                if (day_string.get(pos).equals(date)) {
                    ...
                    drawable.setColor(Color.parseColor(HolidayModel.color));
