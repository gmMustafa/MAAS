...
public class TdNotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerClass.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ArrayAdapter<String> spinnerAdapter =
                        new ArrayAdapter<String>(TdNotificationActivity.this, android.R.layout.simple_spinner_item, arraySubject);
                spinnerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ...
        spinnerSubject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ArrayAdapter<String> spinnerAdapter1 =
                        new ArrayAdapter<String>(TdNotificationActivity.this, android.R.layout.simple_spinner_item, arraySection);
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(TdNotificationActivity.this,TdShowNotificationActivity.class);
