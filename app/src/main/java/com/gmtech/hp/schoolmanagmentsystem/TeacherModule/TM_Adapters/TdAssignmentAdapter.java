...
public class TdAssignmentAdapter extends BaseAdapter {
    ...
    public TdAssignmentAdapter(Context context, List<TeacherpanelModel> models) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        title.setText(models.get(i).getAssignmentTitle());
